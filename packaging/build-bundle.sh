...
echo "    On the target: unzip, then double-click TraceGuard.command."
echo "    macOS first launch: System Settings > Privacy & Security > Open Anyway (older macOS: right-click > Open)."
